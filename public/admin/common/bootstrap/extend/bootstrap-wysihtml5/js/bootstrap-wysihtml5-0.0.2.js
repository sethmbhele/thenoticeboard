!function($, wysi) {
	...
	var templates = {
		...
		"link": 	"<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade' data-backdrop='false'>"
			...
			"image": "<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-image-modal modal hide fade' data-backdrop='false'>"
							+ "<div class='modal-header'>"
							+ "<a class='close' data-dismiss='modal'>&times;</a>"
							  + "<h3>Insert Image</h3>"
							+ "</div>"
